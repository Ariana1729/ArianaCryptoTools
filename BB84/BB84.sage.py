...
_sage_const_4 = Integer(4); _sage_const_100 = Integer(100); _sage_const_0 = Integer(0); _sage_const_2 = Integer(2); _sage_const_1 = Integer(1)
...
for i in range(N):
    q = qbits[i]
    m = mz(q,_sage_const_1 ) if bob_basis[i]=='0' else mx(q,_sage_const_1 )
